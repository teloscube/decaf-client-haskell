...
-- "Token XYZ"
-- >>> mkAuthorization $ IT.CredentialsBasic "username" "password"
-- "Basic dXNlcm5hbWU6cGFzc3dvcmQ="
-- >>> mkAuthorization $ IT.CredentialsKey "key" "secret"
-- "Key key:secret"
...
mkAuthorization (IT.CredentialsBasic u p) = mkBasicAuth (TE.encodeUtf8 u) (TE.encodeUtf8 p)
mkAuthorization (IT.CredentialsKey k v)   = mkKeyAuth (TE.encodeUtf8 k) (TE.encodeUtf8 v)
